...
class Engine {
 ...
 public:
   ...
   *
   * Initializes the engine if not already done and should be the first call
   * made. This only initializes the CORE services; call initialize() to set up
   * all services.
   */
   ...
   *
   * Must be called before using any engine functionality as it sets up
   * necessary systems. This registers all except the core services, as they
   * utilize the engine instance.
   */
