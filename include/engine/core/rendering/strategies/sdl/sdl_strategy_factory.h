 ...
 *
 * SdlStrategyFactory is responsible for producing instances of SDL-based
 * rendering strategies for various components. It implements the
 * IRenderingStrategyFactory interface and utilizes the provided Renderer to
...
class SdlStrategyFactory final : public IRenderingStrategyFactory {
 public:
  ...
  std::unique_ptr<IRenderingStrategy> create_strategy(
