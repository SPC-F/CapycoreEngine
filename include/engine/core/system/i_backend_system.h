...
/**
 * @brief Interface for backend system implementations handling low-level events.
 * 
 * Defines methods for initializing event listeners, polling events, and managing frame timing.
 * Implementations should translate backend-specific events into engine-recognized events.
 */
