...
struct MessageType {
  ...
  MessageType(Kind kind, uint16_t t) : kind{kind}, value{t} {}
  ...
  static MessageType from_raw(uint16_t raw) {
    ...
    return {isCustom ? MessageType::Kind::Custom : MessageType::Kind::Default,
            value};
  }
 ...
 *
 * The payload is a raw byte buffer whose structure is determined by the message
 * type.
 */
struct Message {
