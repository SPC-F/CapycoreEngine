...
class PhysicsCreationFactory {
 public:
   ...
   */
  Body2D create_body(Vector3 position, BodyType2D::Type type,
                     Component* component);
   ...
   */
  static Body2D create_box_fixture(Body2D body, Point offset, float width,
                                   float height, PhysicsCreationFlags flags);
   ...
   * @return b2BodyId The identifier of the created fixture
   */
  static Body2D create_circle_fixture(Body2D body, Point offset, float radius,
