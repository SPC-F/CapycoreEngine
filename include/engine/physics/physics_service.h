...
class PhysicsService : public IEngineService {
 public:
   ...
   * @note Delta time (dt) should potentially be fixed for consistent physics
   * behavior.
   *
   ...
   *
   * @return std::unique_ptr<PhysicsWorld>& Reference to the physics world
   * instance.
   */
   ...
   *
   * @return std::unique_ptr<PhysicsRaycaster>& Reference to the physics
   * raycaster instance.
   */
   ...
   *
   * @return std::unique_ptr<PhysicsCreationFactory>& Reference to the physics
   * creation factory instance.
   */
