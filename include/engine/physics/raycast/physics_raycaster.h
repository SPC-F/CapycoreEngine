...
class PhysicsRaycaster {
 public:
   ...
   */
  ColliderRayResult raycast_closest(const b2Vec2& origin,
   ...
   */
  std::vector<ColliderRayResult> raycast_all(const b2Vec2& origin,
                                             const b2Vec2& translation,
   ...
   */
  std::vector<ColliderRayResult> raycast_filtered(const b2Vec2& origin,
                                                  const b2Vec2& translation,
