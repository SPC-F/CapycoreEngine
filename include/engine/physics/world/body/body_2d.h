...
struct Body2D {
   ...
   */
  static void set_body_bounciness(const Body2D& body, float bounciness,
   ...
   */
  static void set_body_friction(const Body2D& body, float friction,
                                ShapeType2D::Type type);
   ...
   */
  static void set_body_velocity(const Body2D& body,
   ...
   */
  static void apply_impulse(const Body2D& body,
