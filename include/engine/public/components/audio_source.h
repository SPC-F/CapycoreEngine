 ...
 * @param play_on_awake Whether the audio should play automatically when the
...
class AudioSource : public Component {
 public:
  explicit AudioSource(std::string audio_file_path, bool play_on_awake = true,
  ...
  [[nodiscard]] const std::string& audio_file_path() const noexcept;
  ...
  [[nodiscard]] bool play_on_awake() const noexcept;
  void play_on_awake(bool value) noexcept;

  [[nodiscard]] std::string audio_name() const noexcept;
