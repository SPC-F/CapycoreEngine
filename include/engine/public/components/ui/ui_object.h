...
class UIObject : public GameObject {
 public:
  UIObject(float width, float height, Point pivot, Point anchor, Scene& scene);

  /**
   * @brief Update the UI object.
   *
   * This should be overridden by derived classes to implement specific update
   * logic. Such as handling animations or state changes (e.g pressed, hovered,
   * etc.).
   *
   ...
   *
   * This should be overridden by derived classes to implement specific
   * rendering logic.
   */
