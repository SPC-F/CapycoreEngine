...
/**
 * @brief A prefab factory function that creates a GameObject with predefined components.
 *
 * The factory receives the scene and object name, and returns a fully constructed
 * GameObject with all its components already attached.
 */
