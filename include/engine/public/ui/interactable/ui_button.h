 ...
 *
 * UIButton represents a clickable button in the user interface. It inherits
 * from UIInteractable and adds properties and behaviors specific to buttons,
 * such as handling labels, button colors, and press events.
 */
class UIButton : public UIInteractable {
 public:
  UIButton(Scene& scene, float width, float height, Point pivot, Point anchor,
