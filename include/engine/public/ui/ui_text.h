 ...
 *
 * UIText represents a text element in the user interface. It inherits from
 * UIObject and adds properties specific to text rendering, such as the text
 * content, font name, font size, and color.
 *
 * In its core UIText is a game object with UIObject as its base class. The
...
class UIText : public UIObject {
 public:
  UIText(Scene& scene, std::string text, std::string font,
