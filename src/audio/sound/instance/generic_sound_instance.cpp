...
void GenericSoundInstance::play() { playing_ = true; }
...
bool GenericSoundInstance::is_paused() const noexcept { return paused_; }

bool GenericSoundInstance::is_finished() { return !playing_; }