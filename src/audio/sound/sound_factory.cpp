...
std::shared_ptr<SoundResource> SoundFactory::create_sound_resource(
...
std::unique_ptr<SoundInstance> SoundFactory::create_sound_instance(
    std::shared_ptr<SoundResource>& resource, float volume) {
