...
void yes() {
  ...
  asset_service.register_texture("FRED", "TestTexture2", 12);
  ...
  game_object2.layer(1);
  game_object2.transform().scale({3, 3, 1});
  game_object2.transform().position({16, 16, 0});
  Sprite& sprite2 = game_object2.add_component<Sprite>("TestTexture2", Color(), 0, 0, 1, 1);
