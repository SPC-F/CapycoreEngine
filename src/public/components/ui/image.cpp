...
std::reference_wrapper<Texture> Image::get_texture_for(
...
Image::Image(const std::string& image, int flip_x, int flip_y, int width,
...
int Image::flip_y() const { return flip_y_; }
...
Color Image::color() const { return color_; }
...
const Texture& Image::texture() const { return texture_; }
