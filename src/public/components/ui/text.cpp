...
Text::Text(std::string text, std::string font, std::string font_path,
...
const std::string& Text::font() const { return font_; }
...
const std::string& Text::font_path() const { return font_path_; }
...
int Text::font_size() const { return font_size_; }
...
Color Text::color() const { return color_; }
...
TextAlignment Text::alignment() const { return alignment_; }
...
Point Text::offset() const { return offset_; }
