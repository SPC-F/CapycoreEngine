...
UIButton::UIButton(float width, float height, Point pivot, Point anchor,
                   Scene& scene)
    : UIObject(width, height, pivot, anchor, scene),
      color_(default_color_value, default_color_value, default_color_value,
             default_color_value),
      state_() {}
...
void UIButton::unhover() { state_.is_hovered = false; }
...
void UIButton::disable() { state_.is_disabled = true; }
...
void UIButton::unfocus() { state_.is_focused = false; }
...
void UIButton::deselect() { state_.is_selected = false; }

void UIButton::reset_state() { state_ = UIButtonState{}; }

Color UIButton::color() const { return color_; }
...
UIButtonState& UIButton::state() { return state_; }
