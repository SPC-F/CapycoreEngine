...
UIButton::UIButton(Scene& scene, float width, float height, Point pivot,
                   Point anchor, const std::string& label,
...
void UIButton::update(float dt) { update_interaction(dt); }
