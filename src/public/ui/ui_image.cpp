...
UIImage::UIImage(Scene& scene, std::string image_path, float width,
                 float height, Point pivot, Point anchor)
  ...
  add_component<Image>(image_path_, default_flip_x, default_flip_y,
...
const std::string& UIImage::image_path() const { return image_path_; }
...
Color UIImage::color() const { return color_; }
