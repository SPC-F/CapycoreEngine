...
UIText::UIText(Scene& scene, std::string text, std::string font,
               std::string font_path, float width, float height, Point pivot,
               Point anchor)
...
const std::string& UIText::text() const { return text_; }
...
const std::string& UIText::font() const { return font_; }
...
const std::string& UIText::font_path() const { return font_path_; }
...
int UIText::font_size() const { return font_size_; }
...
Color UIText::color() const { return color_; }
