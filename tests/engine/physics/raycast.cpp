...
TEST_CASE("physics_raycaster_closest_returns_valid_result",
          "[PhysicsRaycaster]") {
  // arrange
  PhysicsWorld world;
  ...
  Body2D box =
      factory.create_body({0.0f, 5.0f, 0.0f}, BodyType2D::Static, nullptr);
...
TEST_CASE("physics_raycaster_all_returns_sorted_results",
          "[PhysicsRaycaster]") {
  // arrange
  PhysicsWorld world;
  PhysicsCreationFactory factory(world.world_id());
  ...
  Body2D box1 =
      factory.create_body({0.0f, 3.0f, 0.0f}, BodyType2D::Static, nullptr);
  box1 = factory.create_box_fixture(box1, {0.0f, 0.0f}, 2.0f, 2.0f, flags);

  Body2D box2 =
      factory.create_body({0.0f, 6.0f, 0.0f}, BodyType2D::Static, nullptr);
...
TEST_CASE("physics_raycaster_filtered_respects_category_mask",
          "[PhysicsRaycaster]") {
  // arrange
  PhysicsWorld world;
  PhysicsCreationFactory factory(world.world_id());
  ...
  auto results_matching =
      raycaster.raycast_filtered({0.0f, 0.0f}, {0.0f, 10.0f}, matching_mask);
  ...
  auto results_non_matching = raycaster.raycast_filtered(
      {0.0f, 0.0f}, {0.0f, 10.0f}, non_matching_mask);
...
TEST_CASE("physics_raycaster_segment_matches_closest", "[PhysicsRaycaster]") {
  ...
  REQUIRE(segment_result.shape_id.generation ==
          closest_result.shape_id.generation);
...
TEST_CASE("physics_raycaster_closest_static_behind_dynamic",
          "[PhysicsRaycaster]") {
  PhysicsWorld world;
  PhysicsCreationFactory factory(world.world_id());
  PhysicsRaycaster raycaster(world.world_id());
  ...
  Body2D static_body =
      factory.create_body({0.0f, 3.0f, 0.0f}, BodyType2D::Static, nullptr);
  static_body = factory.create_box_fixture(static_body, {0.0f, 0.0f}, 2.0f,
                                           2.0f, static_flags);

  Body2D dynamic_body =
      factory.create_body({0.0f, 6.0f, 0.0f}, BodyType2D::Dynamic, nullptr);
  dynamic_body = factory.create_box_fixture(dynamic_body, {0.0f, 0.0f}, 2.0f,
                                            2.0f, dynamic_flags);
...
TEST_CASE("physics_raycaster_misses_static_hits_dynamic",
          "[PhysicsRaycaster]") {
  PhysicsWorld world;
  PhysicsCreationFactory factory(world.world_id());
  PhysicsRaycaster raycaster(world.world_id());
  ...
  Body2D static_body =
      factory.create_body({5.0f, 5.0f, 0.0f}, BodyType2D::Static, nullptr);
  static_body = factory.create_box_fixture(static_body, {0.0f, 0.0f}, 2.0f,
                                           2.0f, static_flags);

  // dynamic box directly in the path
  Body2D dynamic_body =
      factory.create_body({0.0f, 5.0f, 0.0f}, BodyType2D::Dynamic, nullptr);
  dynamic_body = factory.create_box_fixture(dynamic_body, {0.0f, 0.0f}, 2.0f,
                                            2.0f, dynamic_flags);
...
TEST_CASE("physics_raycaster_all_multiple_bodies_at_angle",
  ...
  Body2D body1 =
      factory.create_body({1.0f, 2.0f, 0.0f}, BodyType2D::Dynamic, nullptr);
  body1 = factory.create_box_fixture(body1, {0.0f, 0.0f}, 2.0f, 2.0f, flags);

  Body2D body2 =
      factory.create_body({4.0f, 5.0f, 0.0f}, BodyType2D::Dynamic, nullptr);
