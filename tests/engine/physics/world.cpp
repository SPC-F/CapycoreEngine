...
TEST_CASE("physics_world_world_exists_returns_false_for_invalid_world",
          "[PhysicsWorld]") {
  // arrange
  PhysicsWorld world;
...
TEST_CASE("physics_world_world_exists_returns_true_for_valid_world",
          "[PhysicsWorld]") {
  // arrange
  PhysicsWorld world;
...
TEST_CASE("physics_world_sets_body_transform", "[PhysicsWorld]") {
  ...
  Body2D body =
      factory.create_body(initial_position, BodyType2D::Static, nullptr);
  body = factory.create_box_fixture(body, {0.0f, 0.0f}, 1.0f, 1.0f, flags);
...
TEST_CASE("physics_world_calculates_distance_between_bodies",
          "[PhysicsWorld]") {
  // arrange
  PhysicsWorld world;
...
TEST_CASE("physics_world_calculates_fixture_distance_between_bodies",
          "[PhysicsWorld]") {
  // arrange
  PhysicsWorld world;
