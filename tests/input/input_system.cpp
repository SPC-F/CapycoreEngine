...
TEST_CASE("is_key_held_should_return_true_when_key_current_is_true",
          "[InputSystem]") {
...
TEST_CASE(
    "is_key_pressed_should_return_true_only_when_key_transitions_to_pressed",
    "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE(
    "is_key_released_should_return_true_only_when_key_transitions_to_released",
    "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE("any_key_held_should_return_true_when_any_key_is_held",
          "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE("any_key_pressed_should_return_true_when_any_key_is_pressed",
          "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE("any_key_released_should_return_true_when_any_key_is_released",
          "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE("is_mouse_held_should_return_true_when_button_current_is_true",
          "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE(
    "is_mouse_pressed_should_return_true_only_when_button_transitions_to_"
    "pressed",
    "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE(
    "is_mouse_released_should_return_true_only_when_button_transitions_to_"
    "released",
    "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE("any_mouse_held_should_return_true_when_any_mouse_button_is_held",
          "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE(
    "any_mouse_pressed_should_return_true_when_any_mouse_button_is_pressed",
    "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE(
    "any_mouse_released_should_return_true_when_any_mouse_button_is_released",
    "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE("mouse_moved_should_return_true_when_delta_is_nonzero",
          "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE("mouse_scroll_direction_should_return_last_scroll_direction",
          "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
...
TEST_CASE("reset_state_should_reset_all_key_and_mouse_states",
          "[InputSystem]") {
  TestableInputSystem input;
...
TEST_CASE("update_should_move_current_to_previous_for_keys_and_mouse_buttons",
          "[InputSystem]") {
  TestableInputSystem input;
  input.reset_state();
