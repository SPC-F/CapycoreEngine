...
TEST_CASE("mouse_button_state_reset_should_set_current_and_previous_to_false",
          "[MouseButtonState]") {
...
TEST_CASE("mouse_wheel_state_reset_should_reset_scroll_and_delta_values",
          "[MouseWheelState]") {
...
TEST_CASE("mouse_state_reset_should_reset_position_and_deltas",
          "[MouseState]") {
